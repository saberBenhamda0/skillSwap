...
export const SignComponent = (props) => {
  return (
    ...
    className='z-10 flex flex-col items-center justify-center w-2/3 mb-8 h-1/2 lg:w-full lg:h-full '>
    <h3 className='text-center font-body font-bold text-2xl text-[#313131] mb-2 '>{props.title}</h3>
    <img alt='hero section image' className=' lg:w-[300px] w-full h-32 lg:h-[160px] border-2  rounded-2xl ' src={props.src} />
  </motion.div>
    )
}
  ...
  return (
    <div className='relative w-full h-screen'>
      <div className='flex flex-row w-full '>
        ...
        <img alt='hero section image' className='absolute h-0  w-0 bottom-20 right-24 lg:mt-0 lg:ml-0 z-10 lg:w-[710px] lg:h-[541px] lg:right-24 lg:top-0 ' src={hero_section} />
      </div>
