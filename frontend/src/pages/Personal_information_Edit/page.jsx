...
const PersonalInformation = () => {
  ...
  const [sendAddInfoRequest] = useSendAddInfoRequestMutation()
  ...
  const handleClick = async () => {
    let response = await sendAddInfoRequest(info).unwrap()
  ...
  return  (
    <div
    className='flex active:opacity-50 flex-row items-center justify-center text-center cursor-pointer text-[#979797] w-16 h-10 lg:w-[100px] lg:h-[50px] mr-6 mb-16 rounded-lg border-solid border-2 border-green-500'
      onClick={handleClick}>
      <p className='m-2 text-sm text-green-500 lg:text-base '>save</p>
      <img className='w-5 h-5 lg:w-8 lg:h-8 ' src={accept} />
    </div>
  );}
    ...
    <div className='flex flex-col relative w-screen bg-[#F1F3FF] items-center justify-center h-full'>
      ...
      <div className='mt-[33px] flex flex-col items-start justify-between lg:ml-32 bg-white w-10/12 lg:w-8/12 h-3/5 rounded-2xl shadow'>
        ...
        <div className='flex flex-row flex-wrap items-center justify-between w-full'>
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>First Name:</h6>
            <input
              onChange={handleChange}
              name="first_name"
              value={info.first_name}
              type='text'
              className='w-full border-solid border-2 rounded-l border-[#EFEFF4] my-2 text-xl text-center font-body'
            />
          </div>
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>Last Name:</h6>
            <input
              onChange={handleChange}
              name="last_name"
          ...
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>Job:</h6>
            <input
              onChange={handleChange}
              name="Job"
              value={info.Job}
          ...
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>Email:</h6>
            <input
              onChange={handleChange}
              name="email"
              value={info.email}
          ...
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>Phone Number:</h6>
            <input
              onChange={handleChange}
              name="phone_number"
      ...
      <div className='my-[33px] lg:ml-32 bg-white w-10/12 lg:w-8/12 h-3/5 rounded-2xl shadow'>
        <div className='flex flex-row items-center justify-between w-full'>
          <h2 className='ml-6 text-2xl font-bold mb-14 font-body'>Address</h2>
          <div className='mt-8'>
          <EditButton />
          </div>
        </div>
        <div className='flex flex-row flex-wrap items-center justify-between w-full'>
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>Country:</h6>
            <input
              onChange={handleChange}
              name="country"
              value={info.country}
          ...
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>Region:</h6>
            <input
              onChange={handleChange}
              name="region"
              value={info.region}
          ...
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>City:</h6>
            <input
              onChange={handleChange}
              name="city"
              value={info.city}
          ...
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>Neighborhood:</h6>
            <input
              onChange={handleChange}
              name="Neighborhood"
          ...
          <div className='m-4 w-60'>
            <h6 className='text-center font-body text-xl text-[#707487]'>Postal Code:</h6>
            <input
              onChange={handleChange}
              name="PostalCode"
